...
Once your tool is pushed to Hub, you can inspect it. The [`model_downloads_tool` source](https://huggingface.co/spaces/m-ric/hf-model-downloads/blob/main/tool.py) contains all of the tool's logic and shows how to inspect a tool shared by someone else.
